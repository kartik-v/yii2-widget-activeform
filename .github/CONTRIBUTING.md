Contributing to yii2-widget-activeform
======================================
Looking to contribute something to yii2-widget-activeform? **Here's how you can help.**
...
Reporting bugs with yii2-widget-activeform
------------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-widget-activeform_.
...
- What version of jQuery are you using? And what version of yii2-widget-activeform?
- Are you using yii2-widget-activeform with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-widget-activeform
------------------------------------------
Before starting work on a major feature for yii2-widget-activeform, **read the
...
yii2-widget-activeform regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-widget-activeform that contain test cases and
...
[issue-tracker]: https://github.com/kartik-v/yii2-widget-activeform/issues
[licensing]: https://github.com/kartik-v/yii2-widget-activeform/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-widget-activeform
[requesting-features]: #requesting-features-in-yii2-widget-activeform